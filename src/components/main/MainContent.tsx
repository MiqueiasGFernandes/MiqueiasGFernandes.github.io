        ...
        description={[
          {
            ...
            languageIcon: brazil,
            text: <div>
              <p>Sou um <b><i>Nuke Compositor</i> e um <i>Motion Designer</i></b> apaixonado por dar vida à fantasia. Acabei de começar a fazer composição com o Nuke e estou animado para mostrar minhas habilidades com meu primeiro Demo Reel de composição. Com experiência em Motion Design, passei mais de 2 anos criando anúncios de mídia social. Aprendi a <b>superar obstáculos</b> e trabalhar com muita atenção aos detalhes.</p>

              <p>Meu processo criativo é dar vida às minhas ideias. Inspiro-me em tudo o que me rodeia, seja o mais recente sucesso de bilheteira ou a vista da minha janela. Como <i>Nuke Compositor</i>, estou pronto para <b>conquistar o mundo</b> e fazer meu nome na indústria.</p>

              <p>Quando criança, descobri minha paixão por efeitos visuais brincando com o Adobe After Effects (obrigado Andrew Kramer) e criando vídeos para projetos escolares ou apenas para me divertir com os amigos. Agora, como <i>Nuke Compositor</i>, <b>estou ansioso para trazer essa mesma paixão para o meu trabalho.</b></p>
          ...
          },
          {
            ...
            languageIcon: usa,
            text: <div>
              <p>I am a <b><i>Nuke Compositor</i> and <i>Motion Designer</i></b> with a passion for bringing fantasy to life. I just started Nuke Compositing and I am excited to showcase my skills with my first Nuke demo reel. With a background in motion design, I spent over 2 years creating social media ads. I have learned to <b>overcome obstacles</b> and work with great attention to detail.</p>

              <p>My creative process is all about bringing my ideas to life. I draw inspiration from everything that surrounds me, whether it's the latest blockbuster or the view out my window. As a <i>Nuke Compositor</i>, I am ready to <b>take on the world</b> and make a name for myself in the industry.</p>

              <p>As a kid, I discovered my passion for visual effects by playing around with Adobe After Effects (thanks Andrew Kramer) and creating videos for school projects or just for fun with friends. Now, as a <i>Nuke Compositor</i>, I <b>am looking forward to bringing that same passion into my work.</b></p>
